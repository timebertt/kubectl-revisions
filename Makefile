...
kind-up: $(KIND) $(KUBECTL) ## Launch a kind cluster for local development and testing.
	$(KIND) create cluster --name revisions --config hack/kind-config.yaml --image kindest/node:v1.33.2@sha256:c55080dc5be4f2cc242e6966fdf97bb62282e1cd818a28223cf536db8b0fddf4
